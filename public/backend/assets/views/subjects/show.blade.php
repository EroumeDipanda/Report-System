...
@section('title', __('messages.subjects.title_show'))
                            ...
                            <div
                                ...
                                @if (Auth::user()->role != 'user')
                                    @if ($upload->status == 'pending')
                                        <form id="process-form" action="{{ route('subjects.process', $upload->id) }}"
                                    ...
                                    @elseif ($upload->status == 'processed')
                                        <a href="{{ route('subjects.viewProcessed', $upload->id) }}"
                                    ...
                                    @if ($upload->status === 'pending')
                                        <form action="{{ route('subjects.reject', $upload->id) }}" method="POST"
                                    ...
                                    @endif
                                @endif
                                <a href="{{ route('subjects.download', $upload->id) }}"
                    ...
                    <div class="table-responsive" style="height: 55vh; overflow-auto;">
                        <table class="table table-bordered">
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="7" class="text-center">{{ __('messages.subjects.table_no_data') }}
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
