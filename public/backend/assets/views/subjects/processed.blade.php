                ...
                <div class="card-body">
                    ...
                    <div class="row mt-3 mb-3">
                        <div class="col-12 d-flex flex-column flex-md-row justify-content-between">
                            ...
                            <!-- Action Buttons -->
                            <div class="col-md-6 d-flex flex-wrap justify-content-end align-items-center text-center text-md-end">
                                <a href="#" class="btn btn-success d-inline-flex align-items-center mb-2 mb-md-0">
                                    Export to DB &nbsp;<i class="mdi mdi-file-export mdi-24px"></i>
                                </a>
                                <a href="{{ route('subjects.proccess.download', ['fileId' => $upload->id, 'accepted' => true]) }}"
