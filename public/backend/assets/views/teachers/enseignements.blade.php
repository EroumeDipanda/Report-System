                    ...
                    <div class="row mt-3 mb-3">
                        <div class="col-12 d-flex flex-column flex-md-row justify-content-between">
                            ...
                            <div class="col-md-6 mb-3 mb-md-0">
                                ...
                                <!-- Display more file details if needed -->
                            </div>
                            ...
                            <div
                                ...
                                <a href="{{ route('teachers.enseignements.download', ['fileId' => $upload->id]) }}"
                                    class="btn btn-info d-inline-flex align-items-center mb-2 mb-md-0 ms-0 ms-md-2">
                                    Download Enseignements &nbsp;<i class="mdi mdi-download mdi-24px"></i>
                                </a>
                            </div>
                        </div>
