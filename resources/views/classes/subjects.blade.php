                ...
                <div class="card shadow-sm rounded">
                    ...
                    <div class="text-end pe-3">
                        <a class="btn btn-success d-inline-flex align-items-center"
                            href="{{ route('subjects.create', $class->id) }}">
                                    ...
                                    @forelse($subjects as $key => $subject)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <form action="{{ route('subjects.delete', $subject->id) }}" method="GET"
                                                ...
                                                <script>
                                                    ...
                                                    function confirmDelete() {
                                                        return confirm('Are you sure you want to delete this item? This action is irreversible.');
                                                    }
                                                </script>
                                            </td>
                                        </tr>
